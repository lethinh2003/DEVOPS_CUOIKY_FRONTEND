  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        `${configs.endpointServer}/api/v1/baihoc`,
        {
          phanMuc: phanMuc,
          tenBaiHoc: tenBaiHoc,
          noiDung: dataContent,
